...
class YaoLiuSan(object):
    def __init__(self, username=None, password=None, proxies={}):
        self.login_url = 'https://id.163yun.com/login'
        ...
        cur_path = '/Users/daiwang/Desktop'
    ...
    def login(self):
        ...
        # 切换iframe
        # try:
        #     iframe = self.driver.find_element_by_xpath("//iframe[@class='yidun_cover-frame']")
        # except Exception as e:
        #     print('get form failed: ', e)
        #     self.driver.quit()
        #     return {'ret_code': 0, 'description': 'iframe'}
        ...
        return {'ret_code': 0, 'description': '登录成功', 'cookies': cookies, 'page_url': page_url}
